    ...
    <>
      <section className=" flex  flex-col justify-center items-center mx-auto">
        <div className="absolute inset-0 z-0 h-[530px]">
          <Image
            src={
              "https://res.cloudinary.com/dvqgkdvgg/image/upload/v1743937088/IMG-20250406-WA0014_neiwpl.jpg"
            }
            alt={"photo"}
            layout="fill"
            objectFit="cover"
        ...
        <article className=" flex  flex-col items-center justify-between w-full  z-20 relative ">
          <div className="space-y-2 pb-8 pt-3 z-10  md:space-y-5  lg:flex-row  max-w-3xl px-2 sm:px-6 xl:max-w-7xl xl:px-0">
            ...
            <p className="text-slate-200">
              Empresa especializada en electricidad, fontanería, gas y aire
              acondicionado, que apuesta por la innovación y excelencia para
              ofrecer soluciones seguras y eficientes en instalaciones y
              reparaciones. Con un equipo experto y tecnología de vanguardia,
              mejoramos continuamente nuestro Sistema de Gestión Integral para
              superar tus expectativas y garantizar tu tranquilidad.
            </p>
          </div>
